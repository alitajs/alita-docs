...
const Home = () => {
  return (
    <Cards>
      ...
      <Card header="安装" href="/docs/installation/environment" icon={CliImage}>
        <p>有关安装和设置系统以构建 Alita 应用程序的分步指南。</p>
      </Card>
      <Card header="原生能力" href="/plugins/native" icon={NativeImage}>
        <p>
          集成并使用设备的原生能力，快速对接，例如获取图片，修改原生状态栏等.
        </p>
      </Card>
      <Card header="常见问题" href="/docs/faq" icon={FaqImage}>
